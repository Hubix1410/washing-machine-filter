    ...
    return(
        <section className="forms">
            <div className="forms__container">
                ...
                <select name="sortBy"  className="forms__select" value={searchConfig.sortByForm} onChange={(event)=>changeSearchConfig(event, "sortByForm")}>
            ...
            <div className="forms__container">
                ...
                <select name="functions" className="forms__select" value={searchConfig.functions} onChange={(value)=>changeSearchConfig(value, "functions")}>
                    <option className="forms__option" value="all">Wszystkie</option>
                    <option className="forms__option" value="Drzwi AddWash">Drzwi AddWash</option>
                    <option className="forms__option" value="Panel AI Control">Panel AI Control</option>
                    <option className="forms__option" value="Silnik inwerterowy">Silnik inwerterowy</option>
                    <option className="forms__option" value="Wyświetlacz Elektroniczny">Wyświetlacz Elektroniczny</option>
                </select>
            </div>
