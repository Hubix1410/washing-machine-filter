...
import { LoadAll, ProductCard, ResultsAmount } from './components';
    ...
    "models": [
        {
            ...
            "size": "55 x 60 x 85",
            "capacity":9,
            "functions": ["Drzwi AddWash", "Panel AI Control", "Silnik inwetowy"],
            "energyClass": "A",
            "price": 4819,
            "installments": 30,
            "popularity": 4
        ...
        },
        {
            ...
            "size": "55 x 60 x 85",
            "capacity":9,
            "functions": ["Drzwi AddWash", "Silnik inwetowy", "Wyświetlacz Elektroniczny"],
            "energyClass": "A",
            "price": 3909,
            "installments": 30,
            "popularity": 3
        },
        {
            ...
            "size": "55 x 60 x 85",
            "capacity":10,
            "functions": ["Panel AI Control", "Silnik inwetowy", "Wyświetlacz Elektroniczny"],
            "energyClass": "E",
            "price": 3399,
            "installments": 30,
            "popularity": 1
        ...
        },
        {
            ...
            "size": "55 x 60 x 85",
            "capacity":11,
            "functions": ["Silnik inwetowy", "Wyświetlacz Elektroniczny"],
            "energyClass": "B",
            "price": 1200,
            "installments": 30,
            "popularity": 13
...
function ProductSection({searchConfig}) {
    ...
    function fiilterWashingMashine(searchConfig){
        ...
        if(searchConfig.sortByForm !== "all"){
            console.log(searchConfig.sortByForm);
    ...
    const displayData = fiilterWashingMashine(searchConfig);


    return (
        <main className="prodSection">
            <ResultsAmount amount={displayData.length}/>
